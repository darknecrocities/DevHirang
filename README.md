...
### 🔄 Point Synchronization Automation
...
- `/src/data`: Centralized `developers.json` (Single Source of Truth).
- `/src/utils`: `ranking.js` and `badgeUtils.js` (The Scoring Engine).
- `/scripts`: `sync-points.cjs` (Automated Data Maintenance).
- `/src/components`: Atomic, high-fidelity UI component structure.
