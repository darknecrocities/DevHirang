    ...
    return (
        <section className="relative py-20 overflow-hidden rounded-3xl border border-white/10 bg-primary/40">
            <div className="relative text-center space-y-8 px-4">
                ...
                >
                    Dev<span className="text-secondary italic">Hirang</span> – Hall of <br />
                ...
                >
                    <a
                        href="#achievements"
                        className="group bg-secondary hover:bg-white text-background px-8 py-4 rounded-full font-bold transition-all flex items-center gap-2 glow-secondary"
                    >
                        View Achievements
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="px-8 py-4 rounded-full border border-white/10 hover:bg-white/5 font-semibold transition-all inline-block"
                    >
