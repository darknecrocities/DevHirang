import { Trophy, Rocket, Code, Users, Star, Award, ShieldCheck, Globe, Briefcase } from 'lucide-react';
...
export const BADGE_CRITERIA = [
    ...
    },
    {
        id: 'professional',
        label: 'Professional',
        description: 'Demonstrated industry experience through work or internships',
        icon: Briefcase,
        color: 'text-orange-500',
        bgColor: 'bg-orange-500/10',
        borderColor: 'border-orange-500/20',
        check: (dev) => dev.achievements.some(a => a.type === 'work' || a.type === 'intern')
    }
];
